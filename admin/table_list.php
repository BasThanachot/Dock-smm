        ...
        <div class="col-12">           
          <div class="card">
            <div class="card-header">
              <a href="datatable.php?status=ส่งซ่อม" class="btn btn-info">ส่งซ่อม (<?= $statusCounts['ส่งซ่อม'] ?>)</a>
              <a href="datatable.php?status=ยืม/ใช้งาน" class="btn btn-success">ยืม/ใช้งาน (<?= $statusCounts['ยืม/ใช้งาน'] ?>)</a>
              <a href="datatable.php?status=ชำรุด" class="btn btn-warning">ชำรุด (<?= $statusCounts['ชำรุด'] ?>)</a>
              <a href="datatable.php?status=ส่งครุจำหน่าย" class="btn btn-danger">ส่งครุจำหน่าย (<?= $statusCounts['ส่งครุจำหน่าย'] ?>)</a>               
              <a href="datatable.php?status=สูญหาย" class="btn btn-danger">สูญหาย (<?= $statusCounts['สูญหาย'] ?>)</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
